...
#define EXCLAMATION (HID_USAGE_KEY_KEYBOARD_1_AND_EXCLAMATION)
...
/* Keyboard @ (At sign) */
#define AT_SIGN (HID_USAGE_KEY_KEYBOARD_2_AND_AT)
#define AT (AT_SIGN)
...
#define HASH (HID_USAGE_KEY_KEYBOARD_3_AND_HASH)
#define POUND (HASH)
...
/* Keyboard $ (Dollar) */
#define DOLLAR (HID_USAGE_KEY_KEYBOARD_4_AND_DOLLAR)
#define DLLR (DOLLAR)
...
/* Keyboard % (Percent) */
#define PERCENT (HID_USAGE_KEY_KEYBOARD_5_AND_PERCENT)
...
/* Keyboard ^ (Caret) */
#define CARET (HID_USAGE_KEY_KEYBOARD_6_AND_CARET)
...
/* Keyboard & (Ampersand) */
#define AMPERSAND (HID_USAGE_KEY_KEYBOARD_7_AND_AMPERSAND)
...
/* Keyboard * (Asterisk) */
#define ASTERISK (HID_USAGE_KEY_KEYBOARD_8_AND_ASTERISK)
...
#define LEFT_PARENTHESIS (HID_USAGE_KEY_KEYBOARD_9_AND_LEFT_PARENTHESIS)
...
#define RIGHT_PARENTHESIS (HID_USAGE_KEY_KEYBOARD_0_AND_RIGHT_PARENTHESIS)
...
#define UNDERSCORE (HID_USAGE_KEY_KEYBOARD_MINUS_AND_UNDERSCORE)
...
/* Keyboard + (Plus) */
#define PLUS (HID_USAGE_KEY_KEYBOARD_EQUAL_AND_PLUS)
...
/* Keyboard { (Left Brace) */
#define LEFT_BRACE (HID_USAGE_KEY_KEYBOARD_LEFT_BRACKET_AND_LEFT_BRACE)
...
#define RIGHT_BRACE (HID_USAGE_KEY_KEYBOARD_RIGHT_BRACKET_AND_RIGHT_BRACE)
...
/* Keyboard | (Pipe) */
#define PIPE (HID_USAGE_KEY_KEYBOARD_BACKSLASH_AND_PIPE)

/* Keyboard Non-US # and ~ (Non-US Hash/Number and Tilde) */
#define NON_US_HASH (HID_USAGE_KEY_KEYBOARD_NON_US_HASH_AND_TILDE)

/* Keyboard ~ (Tilde) */
#define TILDE2 (HID_USAGE_KEY_KEYBOARD_NON_US_HASH_AND_TILDE)
...
/* Keyboard : (Colon) */
#define COLON (HID_USAGE_KEY_KEYBOARD_SEMICOLON_AND_COLON)
...
/* Keyboard " (Quote) */
#define DOUBLE_QUOTES (HID_USAGE_KEY_KEYBOARD_APOSTROPHE_AND_QUOTE)
...
/* Keyboard ~ (Tilde) */
#define TILDE (HID_USAGE_KEY_KEYBOARD_GRAVE_ACCENT_AND_TILDE)
...
/* Keyboard < (Less Than) */
#define LESS_THAN (HID_USAGE_KEY_KEYBOARD_COMMA_AND_LESS_THAN)
#define LT (LESS_THAN)
...
#define GREATER_THAN (HID_USAGE_KEY_KEYBOARD_PERIOD_AND_GREATER_THAN)
...
/* Keyboard ? (Question) */
#define QUESTION (HID_USAGE_KEY_KEYBOARD_SLASH_AND_QUESTION_MARK)
...
/* Keypad Clear */
#define CLEAR2 (HID_USAGE_KEY_KEYPAD_NUM_LOCK_AND_CLEAR)
...
/* Keyboard Pipe */
#define PIPE2 (HID_USAGE_KEY_KEYBOARD_NON_US_BACKSLASH_AND_PIPE)
